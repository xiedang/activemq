...
public class SendMailUtil {
     ...
     * 发件人
     */
    private static String from = "xdyx1994@163.com";
    ...
    public static boolean sendTextEmail(String to, String code) throws Exception {
        try {
            ...
            // 打开连接
            transport.connect("xdyx1994@163.com", "xie19940306");
    ...
    public static void sendHtmlWithInnerImageEmail() throws MessagingException {
        ...
        // 设置内容编号,用于其它邮件体引用
        imagePart.setContentID("firefoxlogo.png");
